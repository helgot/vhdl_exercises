...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {buttons[0]}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {buttons[2]}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {buttons[4]}]
